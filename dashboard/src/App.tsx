      ...
      <EventStreamProvider>
        ...
        >
          <Routes>
             ...
             * -----------|-------------------------------------------------
             * HOME       | /
             * BUILD      | /workflows, /workflows/builder, /workflows/:name,
             *            |   /templates
             * RUN        | /runs, /runs/compare, /runs/:id, /approvals,
             *            |   /schedules
             * IMPROVE*   | /evolution, /autopilot, /optimizer, /evaluations,
             *            |   /memory                         (*Standard+ gated)
             * OPERATE*   | /system-health, /dead-letter, /violations,
             *            |   /compliance, /integrations (tab),
             *            |   /schedule-monitor               (*Standard+ gated)
             * SETTINGS   | /settings (+ ?tab=general|keys|providers|
             *            |   integrations|advanced)
             * REDIRECTS  | /api-keys -> /settings?tab=keys
            ...
            <Route element={<Layout />}>
              ...
              {/* SETTINGS hub — supports ?tab=general|keys|providers|integrations|advanced.
                  Tabbed content is built by a downstream agent; until then SettingsPage
                  renders as-is and ignores the param. */}
              ...
              {/* REDIRECTS — old standalone routes fold into the Settings hub.
                  ApiKeysPage / IntegrationsPage remain in the repo for the
                  Settings agent to mount as tab content. */}
