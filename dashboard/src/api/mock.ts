...
const MOCK_COMMUNITY_TEMPLATES = [
  {
    ...
    description: "Analyze customer behavior patterns, predict churn risk using multi-step reasoning, and generate personalized retention strategies with automated outreach.",
    author: "sarah-ml",
    author_url: "https://github.com/sarah-ml",
    category: "sales_crm",
    tags: ["ML", "Churn", "Retention", "CRM"],
    step_count: 5,
    models: ["sonnet", "haiku"],
    tools: ["hubspot", "slack"],
  ...
  },
  {
    ...
    description: "Monitors alerts from PagerDuty, correlates logs, runs root cause analysis, and posts incident summary to Slack with remediation steps.",
    author: "k8s-ops",
    author_url: "https://github.com/k8s-ops",
    category: "engineering",
    tags: ["DevOps", "Incident", "Monitoring", "Automation"],
    step_count: 6,
    models: ["sonnet", "opus"],
    tools: ["github", "slack"],
  ...
  },
  {
    ...
    category: "marketing",
    tags: ["Content", "SEO", "Planning", "Marketing"],
    step_count: 4,
    models: ["sonnet", "haiku"],
    tools: ["google_search"],
  ...
  },
  {
    ...
    description: "Parse contract PDFs, extract key clauses, flag risky terms, and generate a plain-language summary with recommended amendments.",
    author: "lawtech-ai",
    author_url: "https://github.com/lawtech-ai",
    category: "hr_legal",
    tags: ["Legal", "PDF", "Compliance", "Contract"],
    step_count: 4,
    models: ["opus", "sonnet"],
    tools: [],
  ...
  },
  {
    ...
    description: "Classify incoming support tickets from email, chat, and social media. Route to the right team, suggest responses, and escalate when needed.",
    author: "supportflow",
  ...
  },
  {
    ...
    description: "Scrape competitor pricing pages daily, detect changes, compare feature matrices, and alert your team in Slack with a visual diff report.",
    author: "pricewatch",
    author_url: "https://github.com/pricewatch",
    category: "sales_crm",
    tags: ["Pricing", "Scraping", "Competitors", "Alerts"],
    step_count: 4,
    models: ["sonnet"],
    tools: ["slack"],
  ...
  },
  {
    ...
    name: "Onboarding Workflow Builder",
    description: "Generate customized employee onboarding checklists based on role, department, and location. Includes task assignments and calendar scheduling.",
    author: "hr-automator",
    author_url: "https://github.com/hr-automator",
    category: "hr_legal",
    tags: ["HR", "Onboarding", "Automation", "Tasks"],
    step_count: 3,
    models: ["sonnet"],
    tools: ["slack"],
  ...
  },
  {
    ...
    name: "Release Notes Generator",
    description: "Pull merged PRs from GitHub, classify changes by type, generate user-facing release notes, and post to Slack and documentation site.",
    author: "devrel-bot",
    author_url: "https://github.com/devrel-bot",
    category: "engineering",
    tags: ["DevRel", "GitHub", "Documentation", "Release"],
    step_count: 4,
    models: ["sonnet", "haiku"],
    tools: ["github", "slack"],
  ...
  },
  {
    ...
    description: "Take a blog post or article URL, extract key points, and generate optimized posts for Twitter/X, LinkedIn, and Instagram with image suggestions.",
    author: "social-sage",
