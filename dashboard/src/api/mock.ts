...
const MOCK_COMMUNITY_TEMPLATES = [
  ...
  },
  {
    ...
    description: "Research industry reports and competitor data to calculate TAM/SAM/SOM with top-down and bottom-up methodology, scenario modeling, and an executive report with chart data.",
    author: "gizmax",
    tags: ["Market-Research", "TAM", "SAM", "SOM", "Strategy"],
    step_count: 6,
    category: "marketing",
  ...
  },
  {
    ...
    description: "Deep-research top competitors with browser scraping and search, produce SWOT analyses, feature comparison matrix, pricing strategy analysis, and a full battlecard dossier.",
    author: "gizmax",
    tags: ["Competitive-Intel", "Strategy", "Research", "SWOT"],
    step_count: 6,
    category: "marketing",
  ...
  {
    slug: "lena-content/customer-persona-builder",
    name: "Customer Persona Builder",
    description: "Mine target market demographics and competitor reviews to build 3-5 data-driven customer personas with journey maps and persona-specific messaging frameworks.",
    author: "lena-content",
    tags: ["Market-Research", "Personas", "Customer-Research", "Messaging"],
    step_count: 6,
    category: "marketing",
  ...
  {
    slug: "pricewatch/pricing-optimizer",
    name: "Pricing Optimizer",
    description: "Research competitor pricing, analyze pricing models, model willingness-to-pay, recommend optimal tier architecture, and generate complete pricing page copy and FAQ.",
    author: "pricewatch",
    tags: ["Pricing", "Strategy", "Revenue", "Competitive-Intel"],
    step_count: 6,
    category: "marketing",
  ...
  {
    slug: "soc2-sherpa/soc2-evidence-harvester",
    name: "SOC2 Evidence Harvester",
    description: "Runs nightly to pull control evidence from GitHub, Jira and S3, classify each artifact against your SOC2 control matrix, and gate any gaps to a human auditor before they hit the report.",
    author: "soc2-sherpa",
    tags: ["soc2", "evidence-collection", "audit", "controls", "continuous-compliance"],
    step_count: 9,
    category: "compliance_grc",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/soc2-sherpa/soc2-evidence-harvester.yaml",
    stars: 906,
    forks: 24,
    downloads: 1294,
    featured: true,
  ...
  {
    slug: "audit-pipe/vendor-risk-intake",
    name: "Vendor Risk Intake & Tiering",
    description: "Fetches a vendor's trust/security page over http, classifies them into a risk tier from SOC2/ISO/sub-processor signals, and routes high-risk vendors to a Slack approval gate while writing every decision to a Notion register with a SHA-256 audit hash-chain.",
    author: "audit-pipe",
    tags: ["vendor-risk", "tprm", "audit-trail", "notion", "risk-tiering"],
    step_count: 8,
    category: "compliance_grc",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/audit-pipe/vendor-risk-intake.yaml",
    stars: 494,
    forks: 12,
    downloads: 706,
    featured: false,
  ...
  {
    slug: "kyc-cascade/sanctions-list-delta-watcher",
    name: "Sanctions List Delta Watcher",
    description: "A sensor polls OFAC, EU and UK consolidated lists on a schedule, a code step diffs against the last snapshot in Postgres, and any new designation hitting an existing customer fires a re-screen plus a Slack escalation.",
    author: "kyc-cascade",
    tags: ["sanctions", "ongoing-monitoring", "ofac", "sensor", "delta"],
    step_count: 7,
    category: "compliance_grc",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/kyc-cascade/sanctions-list-delta-watcher.yaml",
    stars: 253,
    forks: 6,
    downloads: 361,
    featured: false,
  ...
  {
    slug: "repo-rover/cve-to-pr-pipeline",
    name: "CVE-to-PR Pipeline",
    description: "A sensor watches GitHub Security Advisories and OSV feeds, classifies each CVE's blast radius across your repos, opens a PR with the bumped lockfile and an auto-drafted changelog, then gates breaking bumps behind a human reviewer.",
    author: "repo-rover",
    tags: ["security", "dependencies", "cve", "automation", "ci"],
    step_count: 9,
    category: "engineering",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/repo-rover/cve-to-pr-pipeline.yaml",
    stars: 1547,
    forks: 34,
    downloads: 2210,
    featured: true,
  ...
  {
    slug: "deploy-dana/ci-failure-triage",
    name: "CI Failure Triage Bot",
    description: "Pulls failed GitHub Actions run logs over http, parses them in a code step to classify the failure type, races two models for a root-cause summary, and opens a Linear ticket only for real regressions.",
    author: "deploy-dana",
    tags: ["ci-cd", "github-actions", "triage", "linear", "root-cause"],
    step_count: 9,
    category: "engineering",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/deploy-dana/ci-failure-triage.yaml",
    stars: 960,
    forks: 19,
    downloads: 1372,
    featured: true,
  ...
  {
    slug: "deploy-dana/flaky-test-quarantine",
    name: "Flaky Test Quarantine",
    description: "Loops over the last N runs of a job via the GitHub API, computes per-test pass/fail flip-rate in a code step, and auto-files a quarantine PR plus a Linear ticket for any test above the flakiness threshold.",
    author: "deploy-dana",
    tags: ["flaky-tests", "github-actions", "quarantine", "linear", "loop"],
    step_count: 8,
    category: "engineering",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/deploy-dana/flaky-test-quarantine.yaml",
    stars: 324,
    forks: 7,
    downloads: 463,
    featured: false,
  ...
  {
    slug: "ledger-loop/stripe-postgres-settlement-reconciler",
    name: "Stripe to Postgres Settlement Reconciler",
    description: "Pulls the daily Stripe balance-transaction report over http, diffs it against your Postgres ledger in a code step, classifies every mismatch (fee drift, FX rounding, missing capture, duplicate refund), and only escalates true breaks so finance stops eyeballing CSVs.",
    author: "ledger-loop",
    tags: ["reconciliation", "stripe", "postgres", "settlement", "finance-ops", "deterministic"],
    step_count: 9,
    category: "fintech_banking",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/ledger-loop/stripe-postgres-settlement-reconciler.yaml",
    stars: 853,
    forks: 21,
    downloads: 1218,
    featured: true,
  ...
  {
    slug: "kyc-cascade/onboarding-decision-cascade",
    name: "KYC Onboarding Decision Cascade",
    description: "Runs sanctions, PEP and adverse-media screening in parallel via http connectors, classifies match confidence, and gates only the genuine edge cases to a compliance officer so clean applicants clear in seconds.",
    author: "kyc-cascade",
    tags: ["kyc", "aml", "sanctions", "onboarding", "screening", "gate"],
    step_count: 9,
    category: "fintech_banking",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/kyc-cascade/onboarding-decision-cascade.yaml",
    stars: 816,
    forks: 18,
    downloads: 1166,
    featured: true,
  ...
  {
    slug: "ledger-loop/payout-anomaly-sensor",
    name: "Payout Anomaly Sensor",
    description: "A sensor watches the Stripe payouts endpoint on a schedule, a code step computes the expected payout from your Postgres gross-less-fees ledger, and any variance over a basis-point threshold trips a gate that pages on-call before the money lands wrong.",
    author: "ledger-loop",
    tags: ["payouts", "anomaly-detection", "sensor", "stripe", "postgres", "alerting"],
    step_count: 6,
    category: "fintech_banking",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/ledger-loop/payout-anomaly-sensor.yaml",
    stars: 31,
    forks: 1,
    downloads: 44,
    featured: false,
  ...
  {
    slug: "triage-rn/patient-message-triage",
    name: "Patient Message Triage & Acuity Router",
    description: "Classifies inbound patient-portal messages by acuity, races two models for an independent second read, and hard-gates any red-flag symptom to a human nurse with a full audit-trail entry.",
    author: "triage-rn",
    tags: ["triage", "patient-safety", "acuity", "human-in-the-loop", "audit"],
    step_count: 11,
    category: "healthcare",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/triage-rn/patient-message-triage.yaml",
    stars: 913,
    forks: 20,
    downloads: 1304,
    featured: true,
  ...
  {
    slug: "scribe-rx/referral-intake-prior-auth",
    name: "Referral Intake & Prior-Auth Packet Assembler",
    description: "Pulls inbound referral faxes and emails, redacts PHI before any model sees it, classifies clinical urgency, assembles a payer-ready prior-auth packet, and holds it at a human gate before submission.",
    author: "scribe-rx",
    tags: ["prior-auth", "phi-redaction", "referral-intake", "hipaa", "fax", "triage"],
    step_count: 11,
    category: "healthcare",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/scribe-rx/referral-intake-prior-auth.yaml",
    stars: 419,
    forks: 13,
    downloads: 598,
    featured: false,
  ...
  {
    slug: "triage-rn/after-hours-escalation-sensor",
    name: "After-Hours Nurse-Line Escalation Sensor",
    description: "Watches the after-hours message queue, scores each new message for time-critical red flags, and pages the on-call nurse via SMS and Slack the moment a high-acuity case lands instead of waiting for morning rounds.",
    author: "triage-rn",
    tags: ["after-hours", "escalation", "sensor", "on-call", "red-flag"],
    step_count: 7,
    category: "healthcare",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/triage-rn/after-hours-escalation-sensor.yaml",
    stars: 36,
    forks: 2,
    downloads: 52,
    featured: false,
  ...
  {
    slug: "clause-cat/nda-redline-gate",
    name: "NDA Redline with Risk Gate",
    description: "Classifies every NDA clause by risk tier, diffs it against your fallback playbook in code, races two models for the rewrite, and gates anything above your threshold to human counsel before the redline ships.",
    author: "clause-cat",
    tags: ["nda", "redlining", "contract-review", "risk-gate", "legal-ops"],
    step_count: 8,
    category: "hr_legal",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/clause-cat/nda-redline-gate.yaml",
    stars: 372,
    forks: 16,
    downloads: 531,
    featured: false,
  ...
  {
    slug: "offer-otter/new-hire-onboarding-orchestrator",
    name: "New-Hire Onboarding Orchestrator",
    description: "Reads each new hire from an Airtable roster, loops over the onboarding checklist, and auto-nags the IT, payroll and buddy owner on Slack plus a Gmail welcome packet so nothing slips before day one.",
    author: "offer-otter",
    tags: ["onboarding", "airtable", "slack", "people-ops", "checklist"],
    step_count: 9,
    category: "hr_legal",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/offer-otter/new-hire-onboarding-orchestrator.yaml",
    stars: 409,
    forks: 13,
    downloads: 584,
    featured: false,
  ...
  {
    slug: "offer-otter/offer-letter-gate",
    name: "Offer Letter Drafter with Legal-Language Gate",
    description: "Drafts a personalized offer letter from comp inputs, then routes it through a classify and gate step that blocks any at-will, equity or non-compete phrasing legal has not approved before it ever reaches the candidate.",
    author: "offer-otter",
    tags: ["offer-letters", "compliance-gate", "legal-review", "hiring", "approval"],
    step_count: 7,
    category: "hr_legal",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/offer-otter/offer-letter-gate.yaml",
    stars: 166,
    forks: 6,
    downloads: 237,
    featured: false,
  ...
  {
    slug: "eval-engine/judge-bakeoff-router",
    name: "LLM-as-Judge Bakeoff Router",
    description: "Races three candidate models on the same prompt, scores each answer with an LLM judge rubric, gates on a minimum quality threshold, and logs every verdict plus latency and cost to Postgres so routing is backed by measured evals instead of brand preference.",
    author: "eval-engine",
    tags: ["evals", "llm-as-judge", "routing", "race", "benchmark", "cost"],
    step_count: 9,
    category: "llmops_ai_eng",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/eval-engine/judge-bakeoff-router.yaml",
    stars: 873,
    forks: 29,
    downloads: 1247,
    featured: true,
  ...
  {
    slug: "promptsmith-io/prompt-regression-harness",
    name: "Prompt Regression Harness",
    description: "Replays a versioned eval set against a candidate prompt across three providers, classifies each delta as pass/regression/improvement, and posts a Slack scorecard that gates promotion of the new prompt version.",
    author: "promptsmith-io",
    tags: ["prompt-eval", "regression-testing", "ci-gate", "cross-provider", "scorecard"],
    step_count: 11,
    category: "llmops_ai_eng",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/promptsmith-io/prompt-regression-harness.yaml",
    stars: 972,
    forks: 31,
    downloads: 1388,
    featured: true,
  ...
  {
    slug: "trace-tamer/trace-triage-pipeline",
    name: "LLM Trace Triage Pipeline",
    description: "Watches your production LLM error logs, classifies each failure as hallucination/timeout/refusal/tool-error, dedupes via qdrant clustering, and opens one ranked Linear issue per cluster with a minimal repro so your team actions signal, not noise.",
    author: "trace-tamer",
    tags: ["observability", "trace-triage", "failure-modes", "deduplication", "incident"],
    step_count: 9,
    category: "llmops_ai_eng",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/trace-tamer/trace-triage-pipeline.yaml",
    stars: 442,
    forks: 15,
    downloads: 631,
    featured: false,
  ...
  {
    slug: "brandwatch-bea/brand-mention-crisis-triage",
    name: "Brand Mention Crisis Triage",
    description: "Always-on sensor polls Exa and RSS for brand mentions every 10 minutes, classifies sentiment and intent, and routes only crisis-grade mentions to Slack behind a human approve/escalate gate while logging the rest to Postgres.",
    author: "brandwatch-bea",
    tags: ["social-listening", "brand-safety", "sentiment", "crisis", "slack", "sensor"],
    step_count: 9,
    category: "marketing",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/brandwatch-bea/brand-mention-crisis-triage.yaml",
    stars: 1334,
    forks: 33,
    downloads: 1905,
    featured: true,
  ...
  {
    slug: "funnel-fox/competitor-landing-page-sensor",
    name: "Competitor Landing Page Sensor",
    description: "Polls a list of competitor landing pages over http, diffs the rendered copy and pricing in a code step, classifies whether a positioning or price shift happened, and only drafts a response brief into Notion when the change is material.",
    author: "funnel-fox",
    tags: ["competitive-intel", "landing-page", "diff", "sensor", "positioning", "notion"],
    step_count: 8,
    category: "marketing",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/funnel-fox/competitor-landing-page-sensor.yaml",
    stars: 295,
    forks: 17,
    downloads: 421,
    featured: false,
  ...
  {
    slug: "funnel-fox/pricing-page-change-brief",
    name: "Pricing Page Change Brief",
    description: "Scrapes a competitor pricing page over http with a Browserbase/LightPanda race for reliability, extracts every tier and gate in a code step, and drafts a side-by-side positioning brief into Notion only when a tier, price, or feature actually moved.",
    author: "funnel-fox",
    tags: ["pricing-intel", "race", "scrape", "diff", "notion", "competitive"],
    step_count: 6,
    category: "marketing",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/funnel-fox/pricing-page-change-brief.yaml",
    stars: 22,
    forks: 1,
    downloads: 31,
    featured: false,
  ...
  {
    slug: "quota-quokka/inbound-demo-qualifier",
    name: "Inbound Demo-Request Qualifier & Router",
    description: "Enriches every demo request via firmographic http lookup, classifies ICP fit and buying intent, then races hot leads to Slack and Salesforce so the right rep claims them in seconds.",
    author: "quota-quokka",
    tags: ["speed-to-lead", "inbound", "lead-routing", "icp-scoring", "salesforce", "slack"],
    step_count: 9,
    category: "sales_crm",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/quota-quokka/inbound-demo-qualifier.yaml",
    stars: 482,
    forks: 15,
    downloads: 688,
    featured: false,
  ...
  {
    slug: "pipeline-pete/lead-to-opportunity-router",
    name: "Lead-to-Opportunity Router",
    description: "Pulls new leads from HubSpot, enriches each via an http call to your firmographic API, scores fit with a classify step, dedupes against open opps in code, then drafts personalized outreach with model failover and routes to the right rep behind a human gate.",
    author: "pipeline-pete",
    tags: ["lead-routing", "enrichment", "lead-scoring", "hubspot", "salesforce", "failover"],
    step_count: 9,
    category: "sales_crm",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/pipeline-pete/lead-to-opportunity-router.yaml",
    stars: 402,
    forks: 13,
    downloads: 574,
    featured: false,
  ...
  {
    slug: "pipeline-pete/crm-dedupe-merge-guardrail",
    name: "CRM Dedupe & Merge Guardrail",
    description: "A sensor watches for new Salesforce/HubSpot records, a code step fuzzy-matches them against a Postgres golden-record table, and an LLM only adjudicates the ambiguous near-duplicates so reps stop creating the same account twice.",
    author: "pipeline-pete",
    tags: ["dedupe", "data-quality", "golden-record", "salesforce", "postgres"],
    step_count: 6,
    category: "sales_crm",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/pipeline-pete/crm-dedupe-merge-guardrail.yaml",
    stars: 169,
    forks: 6,
    downloads: 241,
    featured: false,
  ...
  {
    slug: "ticket-tide/zendesk-deflect-escalate-router",
    name: "Zendesk Deflect & Escalate Router",
    description: "Classifies inbound Zendesk ticket intent and urgency, races two models for the draft reply, gates refunds and legal threats to a human, and logs every resolution to Postgres so deflection rate is auditable.",
    author: "ticket-tide",
    tags: ["zendesk", "deflection", "escalation", "macro", "human-gate", "triage"],
    step_count: 10,
    category: "support",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/ticket-tide/zendesk-deflect-escalate-router.yaml",
    stars: 1371,
    forks: 35,
    downloads: 1958,
    featured: true,
  ...
  {
    slug: "csat-collie/post-resolution-csat-loop",
    name: "Post-Resolution CSAT & Silent-Churn Loop",
    description: "Loops over every closed Zendesk ticket, classifies the resolution sentiment, and fires a Twilio SMS CSAT survey only to the customers a one-click rating would miss, catching silent churners before they leave.",
    author: "csat-collie",
    tags: ["csat", "churn", "zendesk", "twilio", "loop"],
    step_count: 9,
    category: "support",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/csat-collie/post-resolution-csat-loop.yaml",
    stars: 425,
    forks: 14,
    downloads: 607,
    featured: false,
  ...
  {
    slug: "ticket-tide/csat-dip-escalation-sensor",
    name: "CSAT Dip Escalation Sensor",
    description: "A sensor polls Zendesk for tickets with a fresh sub-3 CSAT rating, classifies the root cause, and loops each one into a Slack escalation with a drafted recovery reply so save-plays fire within minutes, not at the weekly review.",
    author: "ticket-tide",
    tags: ["csat", "sensor", "escalation", "recovery", "save-play", "zendesk"],
    step_count: 7,
    category: "support",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/ticket-tide/csat-dip-escalation-sensor.yaml",
    stars: 33,
    forks: 1,
    downloads: 47,
    featured: false,
  ...
  {
    slug: "eval-engine/cost-tiered-fallback-chain",
    name: "Cost-Tiered Fallback Chain",
    description: "Sends each request to the cheapest model first, classifies whether the answer clears a confidence bar, and only escalates to a pricier tier on low-confidence or timeout via failover, cutting spend on easy queries while guaranteeing a quality floor on the hard ones.",
    author: "eval-engine",
    tags: ["cost-routing", "failover", "classify", "escalation", "tiering"],
    step_count: 7,
    category: "general_ai",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/eval-engine/cost-tiered-fallback-chain.yaml",
    stars: 384,
    forks: 15,
    downloads: 549,
    featured: false,
  ...
  {
    slug: "scribe-rx/phi-redaction-gate",
    name: "PHI Redaction Gate (drop-in pre-model scrubber)",
    description: "A reusable front-end step that scrubs 18 HIPAA Safe Harbor identifiers from inbound documents with a regex and NER pass, then blocks the pipeline at a gate if any residual identifier confidence stays above threshold.",
    author: "scribe-rx",
    tags: ["phi", "redaction", "guardrail", "deidentification", "safe-harbor", "gate"],
    step_count: 6,
    category: "general_ai",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/scribe-rx/phi-redaction-gate.yaml",
    stars: 239,
    forks: 9,
    downloads: 342,
    featured: false,
  ...
  {
    slug: "trace-tamer/eval-regression-gatekeeper",
    name: "Eval Regression Gatekeeper",
    description: "A CI gate that pulls the latest eval run scores over http, compares them to the last green baseline, and blocks the merge (with a Slack thread explaining which failure mode regressed) when accuracy or refusal rate crosses your threshold.",
    author: "trace-tamer",
    tags: ["ci", "eval-gate", "regression", "quality-bar"],
    step_count: 5,
    category: "general_ai",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/trace-tamer/eval-regression-gatekeeper.yaml",
    stars: 25,
    forks: 1,
    downloads: 36,
    featured: false,
  ...
  {
    slug: "clause-cat/clause-risk-classifier",
    name: "Clause Risk Classifier",
    description: "A focused first-pass triage that classifies each clause of a pasted contract into a five-tier risk score with a one-line rationale, so you know what to read before you open the redline tool.",
    author: "clause-cat",
    tags: ["clause-classification", "risk-triage", "contract-review", "legal-ops"],
    step_count: 4,
    category: "general_ai",
    download_url: "https://raw.githubusercontent.com/gizmax/Sandcastle/main/hub/community/clause-cat/clause-risk-classifier.yaml",
    stars: 27,
    forks: 1,
    downloads: 38,
    featured: false,
