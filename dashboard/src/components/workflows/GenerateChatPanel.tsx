...
export function GenerateChatPanel({ open, onClose, onSelect, existingYaml }: GenerateChatPanelProps) {
      ...
      <div className="flex items-center justify-between border-b border-border px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-sm font-semibold text-foreground">
            {isEditing ? "Edit with AI" : "AI Assistant"}
          </h2>
        </div>
        <button
          onClick={handleClose}
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4 min-h-0">
        ...
        {messages.length === 0 && !loading && (
          <div className="flex items-start gap-3">
            ...
            <div className="rounded-lg bg-background/50 border border-border px-3 py-2.5 text-sm text-foreground/80 leading-relaxed">
              {isEditing ? (
                <>
        ...
        {messages.map((msg, i) => (
          ...
          >
            ...
            <div
              className={cn(
                "rounded-lg px-3 py-2.5 text-sm leading-relaxed max-w-[90%]",
                msg.role === "user"
