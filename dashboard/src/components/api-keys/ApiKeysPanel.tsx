...
/**
 * Keys management surface: Sandcastle API tokens (CRUD) plus external service
 * keys (AI providers + infrastructure). Rendered as the "Keys" tab inside the
 * Settings hub, and re-exported as the legacy ApiKeysPage for direct tests.
 *
 * @param embedded - when true the panel omits its own page <h1> (the tab bar
 *   already supplies the section heading) but keeps the "New API Key" action.
 */
